...
export default function MarketingPage() {
  return (
    <main className="min-h-screen bg-gradient-to-br from-[#0b1220] via-[#141018] to-[#0b0b0b]">
      {/* Hero principal */}
        ...
        <div className="rounded-3xl border shadow-xl overflow-hidden bg-gradient-to-r from-amber-500 via-pink-500 to-indigo-600 text-white">
          <div className="p-10 md:p-16 text-center">
            ...
            <div className="mt-8 flex justify-center gap-4">
              <a
                href="/dashboard"
                className="px-5 py-3 rounded-xl bg-white text-black font-semibold shadow hover:opacity-90"
              >
                Accéder au dashboard
              </a>
              <a
                href="#simulateur"
                className="px-5 py-3 rounded-xl bg-white/10 border border-white/30 hover:bg-white/15"
              >
                Calculer vos gains
              </a>
            </div>
...
function CommissionSimulatorRedesign() {
  ...
  return (
    <section className="rounded-3xl border shadow-xl overflow-hidden">
      {/* Bandeau titre */}
      <div className="bg-gradient-to-r from-amber-500 via-pink-500 to-indigo-600 p-8 text-white text-center">
      ...
      {/* Contenu */}
      <div className="bg-[#0b0b0b] p-8 md:p-12 text-white">
        {/* Comparatif */}
